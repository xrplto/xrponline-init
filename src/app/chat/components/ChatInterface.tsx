...
export default function ChatInterface() {
  ...
  if (!isUsernameSet) {
    return (
      <div className="w-full max-w-2xl bg-[#c0c0c0] border-[3px] shadow-[inset_-1px_-1px_#0a0a0a,inset_1px_1px_#dfdfdf,inset_-2px_-2px_grey,inset_2px_2px_#fff] p-1">
    ...
    <div className="w-full max-w-2xl bg-[#c0c0c0] border-[3px] shadow-[inset_-1px_-1px_#0a0a0a,inset_1px_1px_#dfdfdf,inset_-2px_-2px_grey,inset_2px_2px_#fff] p-1">
      ...
      <div className="flex flex-col space-y-4 p-4">
        <div className="flex gap-4">
          ...
          {/* Online Users */}
          <div className="w-48 bg-white border-[2px] border-[#0a0a0a] border-r-[#dfdfdf] border-b-[#dfdfdf] p-2 h-[400px] overflow-y-auto">
